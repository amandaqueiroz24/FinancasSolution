...
namespace Financas.DAO
{
	public class MovimentacaoDAO
	{
		...
		{
			context.Movimentacaos.Add(movimentacao);
			context.SaveChanges();
		}

		public IList<Movimentacao> Lista()
		{
			return context.Movimentacaos.ToList();
		}

		public IList<Movimentacao> BuscaPorUsuario(int? usuarioId)
		{
			return context.Movimentacaos.Where(m => m.UsuarioId == usuarioId).ToList();
		}
		...
		{
			IQueryable<Movimentacao> busca = context.Movimentacaos;
